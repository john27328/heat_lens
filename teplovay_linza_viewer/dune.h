...
#define P0 10 //падающая мощность
...
double L_mf; //в м
    ...
    double C_tf;
    double D_tf;//шаг в с
    double K_tf; //коэффициент теплопроводности//19 Вт/м/К
    double rhof; //плотность 5.27 гр/см^3
    double mKlf;

    double Tkrf; // коэффициент пропускания кристалла
    double Tklf; // коэффициент пропускания клетки
    int P0f; //падающая мощность
